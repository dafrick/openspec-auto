# proof-block-in-code-review Specification

## Purpose
Defines the required `**Proof:**` block that the code-review sub-agent must include in every response, documenting test evidence alongside its verdict.
