# blocker-taxonomy Specification

## Purpose
Defines the reason codes sub-agents use when returning blocked statuses, and how the orchestrator includes those codes in parking PR comments.
