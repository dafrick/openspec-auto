# vision-fit-filter Specification

## Purpose
Defines how the triage sub-agent reads a VISION.md file when present and applies a vision-fit filter as an additional red flag for issues that are clearly outside the product's stated purpose.
