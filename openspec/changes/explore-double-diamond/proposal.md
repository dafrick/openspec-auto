...
- **`skill/openspec-auto/prompts/explore.md`** — restructured around the Double Diamond product development process:
  ...
  - Step 4 (Ideate): generate ≥2 Candidates from the HMW — derived from the problem, not from the issue text; issue's implied approach is not a required candidate
...
- **`skill/openspec-auto/prompts/proposal-review.md`** — expanded judge criteria using Six Thinking Hats:
  - Blue Hat: process check — did the Double Diamond happen? Are required sections present and structurally sound?
...
- `explore-product-thinking`: The Double Diamond structured process for the explore stage — JTBD extraction, POV definition, HMW framing, Candidate ideation, Six Thinking Hats evaluation, Recommendation with Now/Next/Later scoping
- `proposal-review-six-hats`: Six Thinking Hats evaluation framework for proposal-review — Blue/White/Yellow/Black/Red/Green hat criteria replacing and extending the current four-criterion judge
